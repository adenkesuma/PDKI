...
const Footer: FC = () => {
  ...
  return (
    <footer className="container mx-auto px-4 md:px-6 py-8 lg:px-10 mb:mb-6 lg:mb-8 xl:mb-14 lg:py-10 rounded-3xl bg-gradient-to-b from-[#274698] to-[#329E93] mx-auto">
