...
const Login: FC<LoginProps> = ({ handleShowLogin, setShow }) => {
  ...
  return (
    <div className="mx-auto fixed left-0 right-0 bottom-0 top-0 h-[100vh] w-[100%] opacity-95 bg-[#329E93] flex flex-col justify-center gap-12 items-center z-50">
      {/* back icon */}
      ...
      >
        <div className="flex justify-center items-center gap-2">
            ...
            <select name="select-data" id="select-data" className="rounded-xl py-2 px-3 text-[#329E93] font-medium">
        ...
        <button type="submit" className="bg-blue-100 bg-rounded-3xl py-3 px-12 font-semibold text-[#329E93] rounded-2xl">Masuk</button>
      </form>
