...
const ConferenceDetail = ({
    ...
    useEffect(() => {
        const fetchConference = async () => {
            await fetch(`http://localhost:8080/api/route/conference/${conferenceId}`)
            .then((res) => res.json())
            .then((data) => {
                setConference(data)
            })
                ...
                <div>
                    ...
                    <div className="px-4 lg:px-12 mt-8 mb-8">
                        ...
                        <div className="mt-8 flex flex-col gap-2">
                            ...
                            <p className="text-[14px] md:text-[16px] font-medium text-[#1a1a1a]">Ketentuan: {conference?.isFree ? "Gratis" : "Berbayar"}</p>
